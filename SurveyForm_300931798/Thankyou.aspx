...
<h3>Please check below Summary of Survey</h3>
        E-mail : <asp:Label ID="Label1" runat="server" Text="Label" /><br />
        Gender : <asp:Label ID="Label2" runat="server" Text="Label" /><br />
        Marriage : <asp:Label ID="Label3" runat="server" Text="Label" /><br />
        Occupation : <asp:Label ID="Label4" runat="server" Text="Label" /><br />
</div>
    <div>
